...
class HigherWordExtract:
    def __init__(self):
        pass

    def higher_word_extract(self, input):
        data={}
        d =[]
        key_list=[]
        output =""
...
#some time low some time high
        ...
        try:
            ...
            print("Exception is in higher_word_extract py", e)
...
if __name__ == '__main__':
    while True:
         ...
         obj=HigherWordExtract()
         print(obj.higher_word_extract(user_input))
